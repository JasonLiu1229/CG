...
bool Vector3D::operator==(Vector3D &vector3D) const {
    if (abs(vector3D.x - this->x) < 0.000001 and abs(vector3D.y - this->y) < 0.000001 and abs(vector3D.z - this->z) < 0.000001 and vector3D.infty == this->infty){
        return true;
    }
    return false;
}
